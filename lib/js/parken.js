    ...
    try{
      ...
      switch(lots[i].state){
        case "open":
          ...
          var popUpText = "<strong>" + lots[i].name + "</strong><br>" + lots[i].free.toString() + " von " + lots[i].total.toString() + " Parkplätzen sind noch frei.";
          var label = lots[i].free.toString();
          break;
        case "closed":
          var mIcon = redIcon;
          var lClass = 'labelred';
          var popUpText = "<strong>" + lots[i].name + "</strong><br>Parkplatz geschlossen."
          var label = '<span style="margin-left:5px;">\u20e0</span>';
          break;
        default:
          var mIcon = blueIcon;
          var lClass = 'labelblue';
          var popUpText = "<strong>" + lots[i].name + "</strong><br>Keine Daten verfügbar.";
          var label = "P";
          break;
      }
      var lPosition = "right";
